      ...
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="w-[min(100vw-2.5rem,20rem)] rounded-3xl border border-border bg-card p-5 shadow-2xl"
          >
            <p className="mb-1 font-display text-lg font-semibold text-foreground">Need support?</p>
            <p className="mb-4 text-sm leading-6 text-muted-foreground">
              We aim to reply within the same day.
            </p>
